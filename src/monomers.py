...
COMPLEX_ROOT = COMPLEX_XYZ[:-4].split('_')[0]
...
*xyzfile {{charge}} {{spin_plus_two}} complex.xyz
""",
]
...
#    )
    ...
    orca2 = f.shell(
            ...
            inp={"orca_freq.inp": orca_freq, "complex.xyz": COMPLEX_XYZ},
    ...
    orca3 = f.shell(
            ...
            inp={"orca_tddft_s0.inp": orca_tddft_s0, "complex.xyz":COMPLEX_XYZ},
    ...
    orca4 = f.shell(
            ...
            inp={"orca_tddft_s1.inp": orca_tddft_s1, "complex.xyz": COMPLEX_XYZ},
...
#    f.takeout(orca0.out["orca_low_opt.out"], "out/"+low_opt_out)
#    f.takeout(orca0.out["orca_low_opt.xyz"], "out/"+low_opt_xyz)

#    f.takeout(orca1.out["orca_high_opt.out"], "out/"+high_opt_out)
#    f.takeout(orca1.out["orca_high_opt.xyz"], "out/"+high_opt_xyz)

    f.takeout(orca2.out["orca_freq.out"], "out/"+freq_out)
    f.takeout(orca2.out["orca_freq.hess"], "out/"+hess)

    f.takeout(orca3.out["orca_tddft_s0.out"], "out/"+tddft_s0)

    f.takeout(orca4.out["orca_tddft_s1.out"], "out/"+tddft_s1)
